...
public class NoticeController {
    ...
    public ResponseEntity<GroupNoticeResponseDto> create(@Auth Long userId,
        ...
        return new ResponseEntity<GroupNoticeResponseDto>(GroupNoticeResponseDto.of(groupNotice),
                HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<GroupNoticeResponseDto> update(@Auth Long userId, @PathVariable Long id,
        ...
        return new ResponseEntity<GroupNoticeResponseDto>(GroupNoticeResponseDto.of(updated),
                HttpStatus.OK);
    }
    ...
    public ResponseEntity<GroupNoticeResponseDto> getGroupNotice(@Auth Long userId,
            @PathVariable Long id) {
        GroupNoticeResponseDto result =
                GroupNoticeResponseDto.of(groupNoticeService.getGroupNoticeById(id));
