...
public class SwaggerConfig {
        ...
        public AlternateTypeRule getAlternateTypeRule(Type sourceType, Type sourceGenericType,
                ...
                return AlternateTypeRules.newRule(
                                typeResolver.resolve(sourceType,
                                                typeResolver.resolve(sourceGenericType,
                                                                sourceSubGenericType)),
        ...
        public AlternateTypeRule getAlternateTypeRule(Type sourceType, Type sourceGenericType,
                ...
                return AlternateTypeRules.newRule(
                                typeResolver.resolve(sourceType, sourceGenericType),
                                typeResolver.resolve(targetType, targetGenericType));
        }
        ...
        public Docket api() {
                ...
                return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo())
                                ...
                                .alternateTypeRules(getAlternateTypeRule(Collection.class,
                                                WildcardType.class, List.class, WildcardType.class),
                                                getAlternateTypeRule(DeferredResult.class,
                                                                List.class, WildcardType.class,
                                                                List.class, WildcardType.class))
                                .ignoredParameterTypes(PagedResourcesAssembler.class,
                                                Pageable.class, Auth.class)
        ...
        private ApiInfo apiInfo() {
                return new ApiInfoBuilder().title("⏰ Cereal REST API").version("0.0.5")
                                .description("목표 누적 시간 기록 서비스").build();
        }
